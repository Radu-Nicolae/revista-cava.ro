...
class Article
{
    ...
    public function getDatabase()
    {
        ...
        $rk1 = new Article("RK-1 (Subteran)", "Sub un magazin mixt neînsemnat se afla una dintre miile de tuneluri săpate pentru metrou. Lângă traseu se afla una dintre zonele unde locuiau „cretini, mizantropi, excluși, marginalizați”, cum afirma unul dintre vânzătorii magazinului.", "2", "May", "rk1", "Călin Mihai Tănase", "unknown.jpeg", "2/05/2022");
